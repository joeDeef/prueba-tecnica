...
CREATE TABLE fact_admissions (
  ...
  CONSTRAINT fk_date_admision FOREIGN KEY (sk_date_admision) REFERENCES dim_time(id_time),
  CONSTRAINT fk_date_discharge FOREIGN KEY (sk_date_discharge) REFERENCES dim_time(id_time),
  CONSTRAINT fk_patient FOREIGN KEY (sk_patient) REFERENCES dim_patient(id_patient),
  CONSTRAINT fk_doctor FOREIGN KEY (sk_doctor) REFERENCES dim_doctor(id_doctor),
  CONSTRAINT fk_hospital FOREIGN KEY (sk_hospital) REFERENCES dim_hospital(id_hospital),
  CONSTRAINT fk_insurance FOREIGN KEY (sk_insurance_provider) REFERENCES dim_insurance_provider(id_insurance),
  CONSTRAINT fk_medical FOREIGN KEY (sk_medical_condition) REFERENCES dim_medical_condition(id_medical_condition)
);
